        ...
        public async Task<IActionResult> Create(PurchaseHeaderVM purchaseHeaderVM, string token)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    PurchaseHeaderVM phvm = new PurchaseHeaderVM(purchaseHeader.Id, purchaseHeader.CustomerName, purchaseHeader.CustomerPhoneNumber, purchaseHeader.CustomerEmailAddress, purchaseHeader.InvoiceNumber, purchaseHeader.PurchaseDate, purchaseHeader.TotalBill);
