...
namespace Purchase.ViewModels
{
    ...
    public class PurchaseDetailVM()
    {
        ...
        public PurchaseDetailVM(int productId, decimal quantity, int measurementUnitId, decimal unitPrice, decimal totalPrice, int purchaseHeaderId) : this(productId, quantity, measurementUnitId, unitPrice, totalPrice)
        {
        ...
        public PurchaseDetailVM(int productId, decimal quantity, int measurementUnitId, decimal unitPrice, decimal totalPrice, int purchaseHeaderId, string productName, string measurementUnitName) : this(productId, quantity, measurementUnitId, unitPrice, totalPrice, purchaseHeaderId)
        {
